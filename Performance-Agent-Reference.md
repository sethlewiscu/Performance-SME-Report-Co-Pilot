...
> *"The observed timings appear to be within expected performance range. Managerial approval is required before communicating this to the customer. Should I raise this to @performance-tim?"*
...
**Prompt the rep:**
> *"Before I create the sub-reports — have you clearly identified the specific [Product area] component that's slow? (e.g., for List view: is it the view header, custom field rendering, row rendering, the blank task row, etc.?)"*
...
**Actions:**
1. Ask the rep: *"Should I raise this to @performance-tim?"*
